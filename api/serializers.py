...
class ParticipantSerializer(Base64ModelSerializer):
    class Meta:
        model = Participant
        fields = ['id', 'first_name', 'last_name', 'gender', 'pronouns', 'email', 'email_verified',  'mobile', 'picture', 'birthday', 'extras', 'role', 'data_consent_time', 'data_consent_ip', 'media_consent_time', 'media_consent_ip']

class DelegateSerializer(Base64ModelSerializer):
    class Meta:
        model = Delegate
        fields = ['id', 'first_name', 'last_name', 'gender', 'pronouns', 'email', 'email_verified', 'mobile', 'picture', 'birthday', 'extras', 'data_consent_time', 'data_consent_ip', 'media_consent_time', 'media_consent_ip', 'ambassador', 'first_timer', 'represents', 'school', 'forum']

class StudentOfficerSerializer(Base64ModelSerializer):
    class Meta:
        model = StudentOfficer
        fields = ['id', 'first_name', 'last_name', 'gender', 'pronouns', 'email', 'email_verified', 'mobile', 'picture', 'birthday', 'extras', 'data_consent_time', 'data_consent_ip', 'media_consent_time', 'media_consent_ip', 'position_name', 'school_name', 'forum', 'plenary']

class MUNDirectorSerializer(Base64ModelSerializer):
    class Meta:
        model = MUNDirector
        fields = ['id', 'first_name', 'last_name', 'gender', 'pronouns', 'email', 'email_verified', 'mobile', 'picture', 'birthday', 'extras', 'data_consent_time', 'data_consent_ip', 'media_consent_time', 'media_consent_ip', 'english_teacher', 'school']

class ExecutiveSerializer(Base64ModelSerializer):
    class Meta:
        model = Executive
        fields = ['id', 'first_name', 'last_name', 'gender', 'pronouns', 'email', 'email_verified', 'mobile', 'picture', 'birthday', 'extras', 'data_consent_time', 'data_consent_ip', 'media_consent_time', 'media_consent_ip', 'position_name', 'school_name']
...
class AdvisorSerializer(Base64ModelSerializer):
    class Meta:
        model = Advisor
        fields = ['id', 'first_name', 'last_name', 'gender', 'pronouns', 'email', 'email_verified', 'mobile', 'picture', 'birthday', 'extras', 'data_consent_time', 'data_consent_ip', 'media_consent_time', 'media_consent_ip', 'car', 'availability', 'experience', 'help']
