...
from api.permissions import MUNOLDjangoModelPermission, MUNOLDjangoModelPermissionsAnonReadOnly
...
class ConferenceViewSet(GenericMUNOLViewSet):
    ...
    permission_classes = (MUNOLDjangoModelPermissionsAnonReadOnly,)
